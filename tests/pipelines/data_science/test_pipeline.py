...
from kedro_sms_spam_pipeline.pipelines.data_science import create_pipeline as create_ds_pipeline
from kedro_sms_spam_pipeline.pipelines.data_science.nodes import split_data
